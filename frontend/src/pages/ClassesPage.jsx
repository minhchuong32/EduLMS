          ...
          {classes.map(cls => (
            <Link key={cls.id} to={`/classes/${cls.id}`}
              ...
              <div className="w-10 h-10 md:w-12 md:h-12 bg-blue-600 rounded-xl flex items-center justify-center mb-3">
                <span className="text-white font-bold text-base md:text-lg">{cls.gradeLevel}</span>
              </div>
              <h3 className="font-bold text-gray-800 text-sm md:text-base truncate">{cls.name}</h3>
