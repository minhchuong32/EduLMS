      ...
      {loading ? (
        ...
        <div className="space-y-3">
          {announcements.map(ann => (
            <div key={ann.id} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 md:p-5">
              <div className="flex items-start gap-3">
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-2">
                    <h3 className="font-bold text-gray-800 text-sm md:text-base leading-snug">{ann.title}</h3>
                  ...
                  <p className="text-gray-500 text-sm mt-1.5 whitespace-pre-wrap leading-relaxed">{ann.content}</p>
                  <div className="flex items-center gap-2 mt-3 flex-wrap">
                    ...
                    {ann.isGlobal && (
                      <span className="text-xs bg-orange-100 text-orange-600 px-1.5 py-0.5 rounded-full">Toàn trường</span>
                    )}
                  </div>
                </div>
              </div>
