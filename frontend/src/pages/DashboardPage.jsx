  ...
  return (
    <div className="p-4 md:p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-500 text-sm mt-1">Chào mừng bạn đến với EduLMS</p>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 md:p-6">
        <h2 className="text-base md:text-lg font-bold text-gray-800 mb-4">Thông báo mới nhất</h2>
