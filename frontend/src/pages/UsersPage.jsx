...
const emptyCreateForm = { fullName: '', email: '', role: 'student', password: 'School@123' };
const PAGE_SIZE = 10;
...
export default function UsersPage() {
  ...
  const openEdit = async (id) => {
    ...
    try {
      ...
      toast.error(err.response?.data?.error || 'Không tải được thông tin người dùng');
      setEditId(null);
    } finally {
  ...
  return (
    <div className="p-4 md:p-6 max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-5">
        <div>
          <h1 className="text-xl md:text-2xl font-bold text-gray-900">Người dùng</h1>
                ...
                <tr key={u.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-5 py-3">
                    <div className="flex flex-wrap items-center gap-1.5">
                      ...
                      <button type="button" disabled={isSelf(u.id)}
            ...
            <div key={u.id} className="bg-white rounded-2xl border border-gray-100 p-4">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div className="flex-1 min-w-0">
                  <p className="font-medium text-gray-800 text-sm truncate">{u.fullName}</p>
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <button type="button" disabled={isSelf(u.id)} onClick={() => setDeleteTarget(u)}
        ...
        {!loading && total > 0 && (
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mt-4 px-1">
            <p className="text-sm text-gray-500">
              Hiển thị <span className="font-medium text-gray-700">{rangeStart}</span>
              –
        ...
        <div className="fixed inset-0 bg-black/50 flex items-end sm:items-center justify-center z-50 p-0 sm:p-4">
          <div className="bg-white rounded-t-2xl sm:rounded-2xl shadow-2xl w-full sm:max-w-md p-5">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-base font-bold text-gray-800">Tạo tài khoản mới</h2>
              <button type="button" onClick={() => setShowModal(false)} className="p-1 rounded-lg hover:bg-gray-100">
      ...
      {editId && (
        <div className="fixed inset-0 bg-black/50 flex items-end sm:items-center justify-center z-50 p-0 sm:p-4">
          <div className="bg-white rounded-t-2xl sm:rounded-2xl shadow-2xl w-full sm:max-w-md p-5 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-base font-bold text-gray-800">Chỉnh sửa tài khoản</h2>
            ...
            {!editLoading && editForm && (
              <form onSubmit={handleUpdate} className="space-y-3">
                ...
                <div>
                  ...
                  <input type="password" autoComplete="new-password" value={editForm.password} placeholder="Để trống nếu giữ nguyên"
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-[60] p-4">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm p-5">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Xóa vĩnh viễn <span className="font-medium text-gray-800">{deleteTarget.fullName}</span> ({deleteTarget.email}).
              Thao tác không hoàn tác nếu hệ thống cho phép xóa.
            </p>
