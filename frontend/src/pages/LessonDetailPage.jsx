  ...
  return (
    <div className="max-w-4xl mx-auto p-3 md:p-6">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 md:p-8 mb-4 md:mb-6">
        ...
        <h1 className="text-xl md:text-2xl font-bold text-gray-900 mb-1">{lesson.title}</h1>
        <p className="text-gray-400 text-xs md:text-sm mb-5">
          {lesson.teacherName} • {format(new Date(lesson.createdAt), 'dd/MM/yyyy')}
        </p>
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 flex-wrap mb-0.5">
                  ...
                  <span className={`text-xs px-1.5 py-0.5 rounded-full
                    ${c.authorRole === 'teacher' ? 'bg-blue-100 text-blue-600' : 'bg-gray-100 text-gray-500'}`}>
